...
const stats = [
  { id: 1, name: "Total GLM spent", stat: "7197", icon: UsersIcon, change: "122", changeType: "increase" },
  { id: 2, name: "Total Matic spent", stat: "230.1", icon: MailOpenIcon, change: "5.4%", changeType: "increase" },
  { id: 3, name: "Tasks computed", stat: "2310", icon: CursorClickIcon, change: "3.2%", changeType: "increase" },
]
